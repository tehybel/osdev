...
Descriptor Table (GDT) which is an array of descriptors. Each descriptor
...
PIO to query a memory area called the CMOS. 
...
(MMIO). This means that the LAPIC is mapped into memory at a specific,
...
the mpconfig method. It involves searching through parts of physical
...
the physical address of the LAPIC. 
