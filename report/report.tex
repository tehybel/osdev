...
Before our kernel could render a full \gls{gui}, it first needed the ability
...
% TODO also describe the graphics library component
...
\subsection{Implementing the display server}
- maps the LFB with aid from the kernel
- uses a z-buffer for efficiency
- uses simple data structures
- had to be hand-optimized

\subsection{Implementing the graphics library}
- can render fonts
