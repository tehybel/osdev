...
page is 4096 bytes, or 0x1000 in hexadecimal. Thus pages always aligned on
0x1000-byte boundaries. The kernel determines the amount of RAM by using
...
table. Finally we set a bit in \gls{cr0} to signal that the process should use
the page table.
...
address 0xb8000 represents the text on the screen; we can write characters
